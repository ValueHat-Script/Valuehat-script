...
function UIModule.CreateWindow(titleText, footerText)
    ...
    Content.ScrollBarThickness = 0 -- 隱藏滾動條（可依需求調整大小，如 4）
    Content.AutomaticCanvasSize = Enum.AutomaticSize.Y -- 自動更新滾動範圍
    ...
    -- 自動調整高度邏輯（最大限制為 350px，超過時可透過滾輪滑動）
    ...
    local function updateMainSize()
        if not isMinimized then
            ...
            Content.Size = UDim2.new(1, -30, 0, targetContentHeight)
